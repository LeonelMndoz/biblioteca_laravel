...
@endcan
@can('Eliminar libro')
<button wire:click="edit_libro({{ $id }})" wire:key="'edit-'{{ $id }}" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded"><svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
