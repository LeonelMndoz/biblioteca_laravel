            ...
            <div class="mt-2">
                <div class="ml-10 mr-10 mb-10 mt-10">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-1">
                        <div>
                            <label for="titulo" class="block text-sm font-semibold leading-6 text-black">Nombre</label>
                            <div class="mt-2.5">
                                <input type="text" wire:model="name" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm shadow-blue-500 ring-1 ring-inset ring-blue-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-400 sm:text-sm sm:leading-6">
                            </div>
                            <x-input-error for="titulo" />
                        </div>
                        <label for="autor" class="block text-sm font-semibold leading-6 text-black"> Correo</label>
                        <div class="mt-2.5">
                            <input type="text" wire:model="email" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm shadow-blue-500 ring-1 ring-inset ring-blue-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-400 sm:text-sm sm:leading-6">
                        </div>
