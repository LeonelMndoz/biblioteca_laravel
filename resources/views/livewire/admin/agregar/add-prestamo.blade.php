...
<input wire:model="prestamo.fechaprestamo" class="w-full"  type="date">


          </div>

          <div>
        <button wire:click="add_prestamo()" type="submit" class="flex w-full justify-center rounded-md bg-indigo-600 mt-5 px-3 py-3 text-sm font-semibold leading-6 text-white shadow-sm ">Realizar Prestamo</button>
      </div>
        </div>
      </div>
    </div>
