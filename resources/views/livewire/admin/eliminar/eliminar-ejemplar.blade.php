            ...
            <div class="mt-2">
                ...
                <div class="mt-10 flex justify-center">
                    ...
                    <span wire:click="closeModalPopover()">
                        <button wire:click="delete_ejemplar('{{ $id }}')"
                        ...
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate officiis impedit a, voluptatum quaerat quas sint. Iure maiores impedit, optio ut unde voluptatem. Facilis odio blanditiis molestiae quisquam! Rem, sed?
                    </span>
                </div>
            </div>
        </div>
